...
class PersonilFailedController extends Controller
{
    protected $module = 'personil-failed';
    protected $route  = 'personil.gagal';
    protected $view   = 'pengajuan::tad.personil'; // kandidat.wawancara.create
    protected $perms  = 'personil.failed';
        ...
        $this->setPrepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    // 'Gagal Upload'  => route($this->route . '.index'),
                ]
            ]
        );
    }
    ...
    public function grid()
    {
        ...
        $records = TadFailed::with('kepegawaian','riwayatKerja', 'lastEmployment')
            ->when(
            ...
            ->editColumn(
                ...
                function ($r) {
                    $buttons[] = [
                        ...
                        'page' => true,
                        'id' => $r->id,
                        'url' => route($this->route . '.show', ['gagal' => $r->id, 'tab' => 'profile']),
                    ];
    ...
    {
        $record = TadFailed::with('keluarga')->find($id);
    ...
    {
        $record = TadFailed::with('riwayatKerjaBefore')->find($id);
                    ...
                    $buttons = $this->makeDropdown(
                        [
                            [
                                ...
                                'id'    => $r->id,
                                'url' => route('pengajuan.kandidat.wawancara.show', $r->id),
                            ],
