...
class PersonilUnemployedController extends Controller
{
    protected $module = 'personil.unemployed';
    protected $route  = 'personil.belum-bekerja';
    protected $view   = 'pengajuan::tad.personil';
    protected $perms  = 'personil.unemployed';
        ...
        $this->setPrepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Personil Belum Bekerja'  => route($this->route . '.index'),
                ]
            ]
        );
    }
            ...
            ->editColumn(
                ...
                function ($r) {
                    ...
                    $buttons[] = [
                        ...
                        'page' => true,
                        'id' => $r->id,
                        'url' => route($this->route . '.show', ['belum_bekerja' => $r->id, 'tab' => 'profile']),
                    ];
