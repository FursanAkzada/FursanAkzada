...
<div class="modal-body">
    ...
    <div class="form-group row">
        ...
        <label for="" class="col">: {{ $wawancara->kandidat->tad->nama }}</label>
    </div>
    <div class="form-group row">
        <label for="" class="col-3 text-bold">Posisi TAD</label>
        <label for="" class="col">: {{ $wawancara->kandidat->tad->jabatan->NM_UNIT }}</label>
    </div>
    <div class="form-group row">
        <label for="" class="col-3 text-bold">Penempatan</label>
        <label for="" class="col">:
            {{ $wawancara->kandidat->requirement->pengajuan->so->name ?? '' }}</label>
    </div>
