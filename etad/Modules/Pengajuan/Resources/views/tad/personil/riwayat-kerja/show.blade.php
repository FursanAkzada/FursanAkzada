    ...
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-md-10 parent-group">
                <input type="text" class="form-control" name="title" placeholder="Ex : Direktur Utama" value="{{$record->title}}" disabled>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 parent-group">
                        <select name="employment_type" id=""
                            class="form-control base-plugin--select2" disabled>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 parent-group">
                <input type="text" class="form-control" name="company" placeholder="Company" value="{{$record->company ?? '' }}" disabled>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-10 parent-group">
                <textarea name="location_company" class="form-control" id="" cols="30" rows="3"
                    placeholder="Lokasi Company" disabled>{{$record->location_company ?? ''}}</textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 parent-group">
                        ...
                        value="{{$record->start_date->format('d/m/Y')}}" disabled>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 parent-group">
                        ...
                        placeholder="Tgl Akhir" value="{{$record->end_date->format('d/m/Y')}}" disabled>
                    </div>
                </div>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-10 parent-group">
                <textarea name="description" class="form-control" id="" cols="30" rows="3"
                    placeholder="Deskripsi" disabled>{{$record->description ?? ''}}</textarea>
            </div>
        </div>
    </div>
</form>
