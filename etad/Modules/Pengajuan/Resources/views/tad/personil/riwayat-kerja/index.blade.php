        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h5 class="card-label">Informasi Riwayat Kerja<small>({{ $record->nama }})</small></h5>
                </div>
                <div class="card-toolbar">
                    <a href="{{ route($route . '.riwayatKerja.create', $record->id) }}"  data-placement="bottom" class="btn btn-primary base-modal--render" data-modal-backdrop="false" data-modal-v-middle="false" data-modal-size="modal-xl"><i class="fas fa-plus"></i>
                        Tambah Riwayat Kerja</a>
                </div>
            </div>
            <div class="card-body">
