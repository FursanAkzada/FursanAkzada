            ...
            <div class="form-group row">
                ...
                <div class="col-md-8 parent-group">
                    <input type="text"  name="tgl_wawancara"
                            ...
                            data-options='@json(['endDate' => '', 'format' => 'dd/mm/yyyy'])' placeholder="{{ __('Tgl Pengajuan') }}" @if($record->tgl_wawancara) value="{{ $record->tgl_wawancara->format('d/m/Y') }}" @endif disabled>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label">{{ __('Curiculum Vitae') }}</label>
                <div class="col-md-8 parent-group">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label">{{ __('Pewawancara') }}</label>
                <div class="col-md-8 parent-group">
                                        ...
                                        <td class="text-left" colspan="7">
                                            ...
                                            <div class="parent-group">
                                                <textarea name="keterangan" class="form-control"
                                                    placeholder="{{ __('Deskripsi') }}" disabled>{{ $record->keterangan }}</textarea>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
...
<script>
    // $('.modal-dialog.content-page.modal-xl.modal-dialog-centered.modal-dialog-right-bottom')
