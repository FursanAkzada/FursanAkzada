<form action="{{ route($route . '.detail.store-quota', $periode->id) }}" method="POST">
    @csrf
    <input type="hidden" name="pengajuan_tad_quota_periode_id" value="{{ $periode->id }}">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input class="form-control masking-quota" id="quota" inputmode="numeric" min="0" max="1000" maxlength="1000"
                name="quota" placeholder="Quota" type="number">
        </div>
    </div>
