<form action="{{ route($route.'.kandidat.tl.store',$requirement->id) }}" method="POST">
  @csrf
  ...
  <div class="modal-body">
    {{-- <div class="form-group row">
      <label for="" class="text-bold col-4"></label>
    </div> --}}
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col parent-group">
        <input type="text" class="form-control" name="no_surat" placeholder="Nomor Surat Persetujuan">  
      </div>
    </div>
    <div class="form-group row">
