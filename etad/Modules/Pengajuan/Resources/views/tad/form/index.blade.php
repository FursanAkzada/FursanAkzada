...
@section('filters')
    <div class="mr-2">
        <input type="text" class="form-control filter-control" data-post="keyword" placeholder="No Tiket"
            style="width: 150px">
    </div>
    <div class="mr-2" style="width: 250px">
        <select class="form-control base-plugin--select2 show-tick filter-control" data-post="location_id"
    ...
    <div class="content-filter-date mr-2" style="width: 300px">
