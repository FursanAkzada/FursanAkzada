...
<div class="d-flex mb-9">
    ...
    <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
        <div class="symbol symbol-50 symbol-lg-120">
            @if (isset($tad->file->foto_filepath) && \Storage::exists($tad->file->foto_filepath))
            ...
            <div class="d-flex flex-column flex-grow-1 pr-8">
                <div class="d-flex flex-wrap mb-4">
                    ...
                    <a href="#" class="text-dark-50 text-hover-primary font-weight-bold">
                        <i class="flaticon2-placeholder mr-2 font-size-lg"></i>{{ $tad->city->name }}</a>
                </div>
                <span class="font-weight-bold mb-4 text-dark-50">{{ $tad->alamat_lengkap }}, {{ $tad->city->name }},
...
<div class="row">
    <div class="col">
        <div class="form-group row">
            <label for="" class="col-4 text-bold">NIK</label>
            <label for="" class="col">: {{ $tad->nik }}</label>
        </div>
        <div class="form-group row">
            <label for="" class="col-4 text-bold">Nomor BPJS</label>
            <label for="" class="col">: {{ $tad->bpjs }}</label>
        </div>
        <div class="form-group row">
            <label for="" class="col-4 text-bold">NPWP</label>
        ...
        <div class="form-group row">
            <label for="" class="col-4 text-bold">Status Perkawinan</label>
        ...
        <div class="form-group row">
            <label for="" class="col-4 text-bold">Pendidikan Terakhir</label>
            <label for="" class="col">: {{ $tad->pendidikan_raw }}, {{ $tad->gelar }}</label>
        </div>
        <div class="form-group row">
            <label for="" class="col-4 text-bold">Rekomendasi</label>
            <label for="" class="col">: {{ $tad->rekomendasi ? $tad->rekomendasi : '-' }}</label>
        </div>
    </div>
    <div class="col">
        <div class="d-flex justify-content-center">
            @if (isset($tad->file->foto_full_filepath) && \Storage::exists($tad->file->foto_full_filepath))
