    ...
    <form action="{{ route($route . '.store') }}" method="POST">
        ...
        <div class="card card-custom">
            <div class="card-header">
                <h4 class="card-title">Form Penilaian TAD
                    <button class="btn btn-success ml-2" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
            ...
            <div class="card-body">
                ...
                <div class="col">
                    <div class="row mb-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <select name="vendor_id" id="vendorCtrl" class="form-control base-plugin--select2-ajax"
                                        data-url="{{ route('master.vendor.ajaxAll') }}" title="Vendor">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <select name="personil" id="personilCtrl" class="form-control base-plugin--select2"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <select class="form-control base-plugin--select2-ajax"
                                        ...
                                        data-url-origin="{{ route('settings.user.ajax.selectAjaxUserDivisiHC') }}" id="toCtrl"
                                        name="to" title="Kepada">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label font-weight-bold">Periode</label>
                                <div class="col-4">
                                    <input class="form-control base-plugin--datepicker-3" data-language="en" id="yearCtrl"
                                        name="tahun" placeholder="Periode Tahun" value="{{ date('Y') }}">
                                </div>
                                        ...
                                        <div class="col-4 col-form-label parent-group"
                                            ...
                                            <div class="radio-inline" style="justify-content:center;">
                                                <label class="radio radio-success">
                                                    <input type="radio" name="question[0][{{ $child->id }}]"
                                                        value="1" />
                                                    <span></span>
                                                    1
                                                </label>
                                                ...
                                                <label class="radio radio-success">
                                                    <input type="radio" checked name="question[0][{{ $child->id }}]"
                                                        value="5" />
                                                    <span></span>
                                                    5
                                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="prestasi" id="" cols="30" rows="3" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="text-bold">Indisipliner Tertentu Yang Perlu Dicatat</label>
                        <textarea name="indisipliner" id="" cols="30" rows="3" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="text-bold">Saran dan Perbaikan</label>
                        <textarea name="saran" id="" cols="30" rows="3" class="form-control"></textarea>
                    </div>
                    {{-- <div class="form-group">
                    ...
                    if (me.val()) {
                        $.ajax({
                            ...
                            success: function(response, state, xhr) {
                                ...
                                $('#personilCtrl').select2();
                                console.log(54, response, options);
                                // $('#personilCtrl').prop('disabled', false)
                                //     .data(
                                //         'url-origin',
                                //         '{{ route('personil.migrasi.getAjaxPenilaianTADCekPosisi') }}?cabang_id=' +
                                //         $('#unitKerjaCtrl').val() + '&jabatan_id=' + me.val()
                                //     );
                            },
                            error: function(a, b, c) {
                                console.log(a, b, c);
