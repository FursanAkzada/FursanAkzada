...
<body class="page">
    ...
    <main>
        <table class="table-borderless table" style="border:none;padding-top: 0px;">
            <tbody>
                ...
                <tr>
                    <td><b>Perihal<b></td>
                    <td class="text-center" style="width: 10px;">:</td>
                    <td colspan="3"><b style="text-decoration: underline;">{{ __('Penilaian Vendor') }}</b></td>
                </tr>
            </tbody>
        </table>
        <br>
        ...
        <table class="table-borderless table" style="border:none;padding-top: 0px;">
            <tbody>
                <tr>
                    <td>Unit Kerja</td>
                    <td class="text-center" style="width: 10px;">:</td>
                    <td colspan="3">{{ $record->unitKerja->name }}</td>
                </tr>
                <tr>
                    <td>Vendor</td>
                    <td class="text-center" style="width: 10px;">:</td>
        ...
        <div class="page-break-inside:avoid;">
            <table class="table-data" style="margin-top: 25px; padding-bottom: 0 8px; width: 100%" border="1">
                <thead>
                    <tr>
            ...
            <table class="table-data" style="margin-top: 25px;padding-bottom: 0 8px; width: 100%" border="1">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: justify;">{{ $record->kritik }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: justify;">
                            <b>Saran</b>
                        ...
                        <td style="text-align: center;">:</td>
                        <td style="text-align: justify;">{{ $record->saran }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
