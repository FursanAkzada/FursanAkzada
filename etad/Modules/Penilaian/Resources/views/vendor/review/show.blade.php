...
<form action="{{ route('penilaian.vendor.review.review', $record->id) }}" method="POST">
    @csrf
    <div class="modal-footer">
        <div class="custom-control custom-checkbox text-left" style="width:80%">
            <input type="checkbox" class="custom-control-input" checked id="customControlAutosizing" name="status"
                value="1" required>
            <label class="custom-control-label" for="customControlAutosizing">Saya sudah mengetahui penilaian vendor
                ini</label>
        </div>
        <br>
