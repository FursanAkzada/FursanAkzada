                ...
                <div class="row mb-5">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8 parent-group">
                                <input class="form-control" name="no_pengajuan"
                                    placeholder="{{ __('No Perpanjangan Kontrak') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 parent-group">
                                <select id="posisiCtrl" name="position_id" class="form-control base-plugin--select2-ajax"
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 parent-group">
                                <input class="form-control disabled" name="nio"  id="tempNIO" placeholder="{{ __('NIO') }}" readonly style="background-color: #F3F6F9">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-4 col-form-label font-weight-bold">Tgl Akhir Kontrak
                                Lama</label>
                            <div class="col-8 parent-group">
                                <input type="hidden" id="hiddenContractDue" name="tgl_akhir_kontrak_lama" value="">
                                <input class="form-control base-plugin--datepicker-1" data-language="en"
                                    disabled id="tempContractDue"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="file" style="color:#B5B5C3;font-weight:400;" style="color:#B5B5C3;font-weight:400;">{{ 'Pilih file' }}</label>
                                </div>
                ...
                .on('change', '#posisiCtrl', function() {
                    ...
                    if (me.val()) {
                        ...
                        $('#personilCtrl').on('change', function() {
                            ...
                            $('#hiddenContractDue').val(dataContractDueValue);
                        });
                    }
                });
        });
