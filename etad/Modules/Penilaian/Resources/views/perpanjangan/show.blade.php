                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 parent-group">
                                <input class="form-control base-plugin--datepicker-1" data-language="en"
                                    ...
                                    data-options='@json(['startDate' => now()])' name="tgl_awal_kontrak_lama"
                                    placeholder="Tgl Akhir Kontrak Lama"
                                    value="{{ $record->tgl_akhir_kontrak_lama ? $record->tgl_akhir_kontrak_lama->format('d/m/Y') : '' }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <select name="to" id="" class="form-control base-plugin--select2-ajax"
                                    ...
                                    @if ($record->toUser)
                                        <option value="{{ $record->to }}" selected>{{ $record->toUser->name }}
                                            ({{ $record->toUser->position->name }})</option>
                                    @endif
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10 parent-group">
                                <select name="cc[]" id="" multiple
                                    ...
                                    data-url="{{ route('master.so.jabatan.select-cc') }}">
