...
<body class="page">
    ...
    <main>
            ...
            <tbody style="border:none;">
                ...
                <tr>
                    ...
                    <td colspan="3" style="border:none;"><b
                            style="text-decoration: underline;">{{ __('Penghargaan TAD') }}</b></td>
                </tr>
            </tbody>
        </table>
        <br>
            ...
            <tr>
                ...
                <td style="border:none; width:55%;text-align:right; float:right; position:relative;">
                    <table
                        ...
                        <tr>
                            <td style="border: none; width: 150px;">{{ __('Tanggal SK') }}</td>
                            <td style="border: none; width: 10px; text-align: left;">:</td>
                            <td style="border: none; text-align: left;">{{ $record->tanggal_reward->translatedFormat('d F Y') }}
                            </td>
                        </tr>
                        <tr>
        ...
        <table style="border:none; width:100%;">
            ...
            <tr>
                <td style="border:none; vertical-align:top; width: 150px;">{{ __('Jenis Penghargaan') }}</td>
                <td style="border:none; vertical-align:top; width: 10px; text-align: left;">:</td>
                <td style="border:none; vertical-align:top; text-align: justify;">{!! $record->jenisPunishment->Lengkap !!}</td>
            </tr>
            <tr>
                <td style="border:none; vertical-align:top; width: 150px;">{{ __('Keterangan') }}</td>
                <td style="border:none; vertical-align:top; width: 10px; text-align: left;">:</td>
                <td style="border:none; vertical-align:top; text-align: justify;">{!! $record->keterangan !!}</td>
            </tr>
        </table>
        <br>
        ...
        @if ($record->approval($module)->exists())
            <div style="page-break-inside: avoid;">
                ...
                <div style="text-align: center; margin-top:20px;">{{ getCompanyCityname() }},
                    {{ $record->updated_at->translatedFormat('d F Y') }}</div>
