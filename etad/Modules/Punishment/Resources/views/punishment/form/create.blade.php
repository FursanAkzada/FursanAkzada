...
<form action="{{ route($route . '.store') }}" method="POST">
    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <button aria-label="Close" class="close" data-dismiss="modal" onclick="location.href='{{ url()->previous() }}'" type="button">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col">
                    <select class="filter-control form-control base-plugin--select2" id="personilCtrl"
                        name="tad_id" title="Pilih Personil TAD">
                            ...
                            <optgroup label="{{ $posisi_tad->NM_UNIT }}">
                                @foreach ($posisi_tad->personils as $personil)
                                    <option value="{{ $personil->id }}"
                                        data-jabatan="{{ $posisi_tad->NM_UNIT }}"
            ...
            <div class="form-group row">
                ...
                <div class="col parent-group">
                    <input class="form-control" type="text" name="sk" placeholder="SK">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col parent-group">
                    <input name="tanggal_sk" class="form-control base-plugin--datepicker-1" data-language="en"
                        ...
                        type="text" placeholder="Pilih Tanggal SK">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col parent-group">
                    <textarea class="form-control" name="eviden" placeholder="Eviden" id="" cols="30"></textarea>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col parent-group">
                    <input class="form-control base-plugin--datepicker-1" data-language="en" type="text"
                        data-format="dd/mm/yyyy"
