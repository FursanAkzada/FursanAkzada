...
class Base
{
    ...
    public static function getModules($moduleName = 'dashboard')
    {
        $modules = [];
        ...
        $modules['change-password'] = 'Ganti Password';
        $modules['auth.login'] = 'Auth/Login';
        $modules['auth.logout'] = 'Auth/Logout';
    ...
    public static function renderMenuTree($menu)
    {
        ...
        if (!empty($menu['section'])) {
            ...
            $first = '<li class="has-sub" data-title="' . __($menu['title']) . '">
                        <a href="' . ($menu['url'] == 'javascript:;' ? 'javascript:;' : url($menu['url'])) . '" class="' . ($menu['url'] !== 'javascript:;' ? 'base-content--replace' : '') . ' menu-link" data-name="' . $menu['name'] . '">';
            ...
            $str = '<li class="' . $menuActive . '" data-title="' . __($menu['title']) . '">
                        <a href="' . ($menu['url'] == 'javascript:;' ? 'javascript:;' : url($menu['url'])) . '" class="' . (empty($menu['reload']) ? 'base-content--replace' : '') . ' menu-link" data-name="' . $menu['name'] . '">';
            if (!empty($menu['icon'])) {
    ...
    public static function renderAsideMenu($menu)
    {
        ...
        if (!empty($menu['section'])) {
            ...
            $str = '<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover" data-title="' . __($menu['title']) . '">
                        <a href="' . ($menu['url'] == 'javascript:;' ? 'javascript:;' : url($menu['url'])) . '" class="menu-link menu-toggle">';
            if (!empty($menu['icon'])) {
                $str .= static::renderIcon($menu['icon']);
            ...
            $str = '<li class="menu-item ' . $menuActive . '" aria-haspopup="true" data-title="' . __($menu['title']) . '">
                        <a href="' . ($menu['url'] == 'javascript:;' ? 'javascript:;' : url($menu['url'])) . '" class="menu-link base-content--replace" data-name="' . $menu['name'] . '">';
            if (!empty($menu['icon'])) {
                $str .= static::renderIcon($menu['icon']);
            } elseif (!empty($menu['bullet'])) {
                $str .= '<i class="menu-bullet menu-bullet-' . $menu['bullet'] . '">
