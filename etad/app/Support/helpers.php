...
if (!function_exists('gs_media')) {
    function gs_media($name = '')
    {
        $bucketName = env('GOOGLE_CLOUD_BUCKET', '');
        return "https://storage.googleapis.com/download/storage/v1/b/".$bucketName."/o/".$name."?alt=media";
        // https://storage.googleapis.com/download/storage/v1/b/pragma-inf/o/htbj16qelly6ksxh0ugf37ghesjzhqwkdObCMQZtH14o0w6qAKHDO2FOvHYhWDKNzuTqWq2g.pdf?alt=media
        // https://storage.googleapis.com/download/storage/v1/b/pragma-inf/o/files/pindnpru8atk7syeatewyywmp9ibngr1yRDc6EExFYvLxScBW8cyQFMJNieoCsM1oOntwmNl.pdf?alt=media
    }
}
