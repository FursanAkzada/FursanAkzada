...
class PushPerpanjangan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'push:perpanjangan';
     ...
     * @var string
     */
    protected $description = 'Sync perpanjangan kontrak personil dari e-TAD ke EHC';
    ...
    {
        $this->output->title('Synchronizing perpanjangan kontrak personil dari e-TAD ke EHC');
            ...
            foreach ($PEGAWAI_MUTASI as $key => $pegawai_mutasi) {
                ...
                if ($tad->kepegawaian) {
                    $tad->kepegawaian->update(
                        [
                            'out_at'        => now()->format('d/m/Y'),
                            'mutation_at'   => now()->format('d/m/Y'),
                        ]
                    );
