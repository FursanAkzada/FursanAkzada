...
var KTApp = function() {
    ...
    var initFileInput = function() {
        ...
        //   $(this).next('.custom-file-label').setAttribute("href", fileName);
            // $('.primary-text').attr("href", "hello");
...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutDemoPanel !== 'undefined') {
        KTLayoutDemoPanel.init('panel-filter');
    }
...
var KTLayoutDemoPanel = function() {
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'panel-filter-close',
            toggleBy: 'panel-filter-toggle'
        });
